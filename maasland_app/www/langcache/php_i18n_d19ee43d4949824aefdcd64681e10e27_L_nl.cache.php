...
const holiday = 'vakantiedag';
const report = 'rapport';
const setting_door_open = 'Deur open tijd (in seconden)';
const setting_clean_reports = 'Reports verwijderen na (in dagen)';
...
const choose = 'Kies...';
const door_timezone_button_info = 'Verwijder tijdzone en sluit de deur';
const door_timezone_button = 'Verwijder tijdzone';
...
const value = 'Waarden';
const apb = 'APB';
const apb_info = 'Gebruik deze controller voor APB';
...
const button_replicate = 'Dupliceren';
const button_replicate_tip = 'Kopieer config naar alle controllers';
const delete_confirm = 'Weet u het zeker?';
const delete_subtext = 'Dit item zal worden verwijderd!';
const message_no_auth = 'Je hebt geen toestemming om deze pagina te bekijken';
...
const warning_change_unreachable = '<b> Let op! - </b>  Wijzigingen op deze pagina kun het systeem onbereikbaar maken!';
const warning_change_network = '<b>Voor het wijzigen van netwerk instellingen op de Master controller.<br>Moeten eerst de netwerk wijzigingen op de Slave controllers worden uitgevoerd:</b>';
