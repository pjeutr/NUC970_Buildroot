...
//original https://github.com/sweetalert2/sweetalert2/blob/v0.4.5/src/sweetalert2.js
...
;(function(window, document) {
  ...
  var alertTypes   = ['error', 'warning', 'info', 'success', 'countdown'];
  var defaultParams = {
    title: '',
    text: '',
    html: '',
  ...
  window.swal.init = function() {
    var sweetHTML = '<div class="' + window.swalClasses.overlay + '" tabIndex="-1"></div><div class="' + window.swalClasses.modal + '" style="display: none" tabIndex="-1">' +
    '<div class="icon error"> <span class="x-mark"><span class="line left"></span><span class="line right"></span></span> </div>' +
    '<div class="icon warning"> <span class="body"></span> <span class="dot"></span> </div> ' +
    '<div class="icon info"></div> ' +
    '<div class="icon countdown"> <span class="line tip"></span> <span class="line long"></span> <div class="placeholder"></div> <div class="fix"></div> </div> ' +
    ...
    '<img class="sweet-image"> <h2>Title</h2><div class="sweet-content">Text</div><hr class="sweet-spacer"><button class="' + window.swalClasses.confirm + '">OK</button><button class="' + window.swalClasses.cancel + '">Cancel</button></div>';
  ...
  function setParameters(params) {
    ...
    if (params.type) {
      ...
      switch (params.type) {
        case 'countdown':
          addClass($icon, 'animate-countdown');
          addClass($icon.querySelector('.tip'), 'animate-success-tip-countdown');
          addClass($icon.querySelector('.long'), 'animate-success-long-countdown');
          break;
        case 'success':
